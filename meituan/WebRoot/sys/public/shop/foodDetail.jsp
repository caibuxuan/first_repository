	...
	<body style="background-color:#F8F8F8 ">
		<div id="outer" style="background-color:#FFFFFF ">
				...
				<table>
					<c:choose>
						<c:when test="${not empty sessionScope.SHOP_MSG }">
							<tr>
								<td rowspan="2">
									<img width="214px" height="145px" src="/${sessionScope.SHOP_MSG.shop_pic}" />
								</td>
			...
			<div id="fooddetail">
				<!-- 菜品图片 -->
				<div id="img">
					<img width="100%" height="200px" alt="sorry" src="/${requestScope.FOOD_MSG.food_pic}">
				</div>
				...
				<!-- 添加和返回按钮 -->
	     		<div id="back" style="float:left;margin-top:150px;margin-left:14px">
